...
# Define prompt for psychology specialist
prompt = """
...
# Load or create psychology chat history
try:
    with open("psychology_chat_history.json", "r") as file:
...
# Save psychology chat history
with open("psychology_chat_history.json", "w") as file:
